...
#print(stop_words)
with open('C:/Users/HP/OneDrive - MNNIT Allahabad, Prayagraj, India/Desktop/rnn_bot/chatbot/int.json') as file:
    data = json.load(file)
...
def check():
    ...
    while True:
        ...
        result = model.predict(pad_sequences(tokenizer.texts_to_sequences([string.lower()]),
